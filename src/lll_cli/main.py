...
def build_parser() -> argparse.ArgumentParser:
    ...
    ss = tsub.add_parser("set-status", help="set task status"); ss.add_argument("workdir"); ss.add_argument("id"); ss.add_argument("status", choices=sorted(VALID_STATUS)); ss.add_argument("--note", default=""); ss.add_argument("--error"); ss.add_argument("--json", action="store_true"); ss.set_defaults(func=cmd_task_set_status)
    ...
    ss = sub.add_parser("set-status", help=argparse.SUPPRESS); ss.add_argument("workdir"); ss.add_argument("id"); ss.add_argument("status", choices=sorted(VALID_STATUS)); ss.add_argument("--note", default=""); ss.add_argument("--error"); ss.set_defaults(func=lambda x: cmd_task_set_status(argparse.Namespace(**{**vars(x), "json": False})))
    return p
