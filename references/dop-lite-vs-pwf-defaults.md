...
- Minimal LLL Lite can be: root `mission.md`, optional `notes.md`, optional task-specific root deliverable, and `internal/validation.json` when checks are nontrivial.
