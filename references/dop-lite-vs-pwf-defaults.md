...
- Minimal LLL Lite can be: root `mission.md`, optional `notes.md`, optional root `01-*` deliverable, and `internal/validation-report.md` when checks are nontrivial.
...
<lll-workdir>/
  ...
  01-<deliverable>.md      # optional human-facing result
  internal/
