...
6. Append to `output/90-error-report.md` for the interrupted worker/scope-repair event and to `output/91-traceability.md` for the source-scope change.
7. Rewrite `output/99-next-steps.md` before continuing so resume state reflects the new mission.
