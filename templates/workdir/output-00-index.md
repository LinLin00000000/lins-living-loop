...
4. [90-error-report.md](90-error-report.md) — append-only workflow/runtime errors, corrections, and self-maintenance notes; each appended entry must include a local-timezone ISO-8601/RFC3339 timestamp.
