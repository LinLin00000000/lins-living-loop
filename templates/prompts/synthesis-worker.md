...
Write:
- <lll-workdir>/01-synthesis.md or another mission-specific root deliverable
...
- Put current next steps inside the primary report/relevant deliverable; do not create standalone Next Steps files.
