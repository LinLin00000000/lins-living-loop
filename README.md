...
如果拿不准，用 LLL Lite：建一个很小的 workdir，写 `mission.md`、`notes.md` 或一个根目录报告，不启动复杂 runner。
...
<lll-workdir>/
  mission.md
  01-<deliverable>.md        # 可选：人类可读产物，和 mission.md 同级
  02-<deliverable>.md        # 可选：内容多/主题独立时再拆分
